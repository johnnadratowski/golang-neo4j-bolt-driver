...
[![Build Status](https://travis-ci.org/mindstand/golang-neo4j-bolt-driver.svg?branch=master)](https://travis-ci.org/mindstand/golang-neo4j-bolt-driver)
[![GoDoc](https://godoc.org/github.com/mindstand/golang-neo4j-bolt-driver?status.svg)](https://godoc.org/github.com/mindstand/golang-neo4j-bolt-driver)
...
```
go get github.com/mindstand/golang-neo4j-bolt-driver
```
...
*_There is much more detailed information in [the godoc](http://godoc.org/github.com/mindstand/golang-neo4j-bolt-driver)_*
